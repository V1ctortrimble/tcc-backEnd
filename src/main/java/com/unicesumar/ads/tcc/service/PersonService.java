            ...
            for(i = 0; i < dto.getContacts().size(); ++i) {
                if (dto.getContacts().get(i) != null) {
                    if ((dto.getContacts().get(i)).getCellPhone() != null) {
                        ((ContactEntity)person.getContacts().get(i)).setCellPhone((dto.getContacts()
                                .get(i)).getCellPhone());
                    }
                    ...
                    if ((dto.getContacts().get(i)).getCellwhats() != null) {
                        ((ContactEntity)person.getContacts().get(i)).setCellwhats((dto.getContacts().get(i))
                                .getCellwhats());
                    }
                }
            }
            ...
            for(i = 0; i < dto.getAdresses().size(); ++i) {
                if (dto.getAdresses().get(i) != null) {
                    if ((dto.getAdresses().get(i)).getAdditional() != null) {
                        ((AdressEntity)person.getAdresses().get(i)).setAdditional((dto.getAdresses().get(i))
                                .getAdditional());
                    }
                    if ((dto.getAdresses().get(i)).getAdress() != null) {
                        ((AdressEntity)person.getAdresses().get(i)).setAdress((dto.getAdresses().get(i))
                                .getAdress());
                    }
                    if ((dto.getAdresses().get(i)).getAdressNumber() != null) {
                        ((AdressEntity)person.getAdresses().get(i)).setAdressNumber((dto.getAdresses().get(i))
                                .getAdressNumber());
                    }
                    ...
                    if ((dto.getAdresses().get(i)).getNeighborhood() != null) {
                        ((AdressEntity)person.getAdresses().get(i)).setNeighborhood((dto.getAdresses().get(i))
                                .getNeighborhood());
                    }
            ...
            for(i = 0; i < dto.getBanksDetails().size(); ++i) {
                if (dto.getBanksDetails().get(i) != null) {
                    if ((dto.getBanksDetails().get(i)).getAccount() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setAccount((dto.getBanksDetails().get(i))
                                .getAccount());
                    }
                    if ((dto.getBanksDetails().get(i)).getActive() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setActive((dto.getBanksDetails().get(i))
                                .getActive());
                    }
                    if ((dto.getBanksDetails().get(i)).getAgency() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setAgency((dto.getBanksDetails().get(i))
                                .getAgency());
                    }
                    if ((dto.getBanksDetails().get(i)).getBank() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setBank((dto.getBanksDetails().get(i))
                                .getBank());
                    }
                    if ((dto.getBanksDetails().get(i)).getDigit() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setDigit((dto.getBanksDetails().get(i))
                                .getDigit());
                    }
                    if ((dto.getBanksDetails().get(i)).getOperation() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setOperation((dto.getBanksDetails().get(i))
                                .getOperation());
                    }
                    if ((dto.getBanksDetails().get(i)).getOperation() != null) {
                        ((BankDetailsEntity)person.getBanksDetails().get(i)).setOperation((dto.getBanksDetails().get(i))
